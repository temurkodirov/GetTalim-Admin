...
export default defineComponent({
    ...
    methods:{
        ...
        openModal(){
            ...
            this.vemail = this.phoneProp;
            this.vstack = this.editStack;
            this.vdesc = this.desc;
        },
        closeModal()
        {
        ...
        async submitForm(){
            ...
            const responce = await axios.put("/api/mentors/" + this.editId, formData, {
                headers: {
...
<template>
  <!-- Modal toggle -->
    <button @click="openModal"
            class="mt-2 w-full justify-center text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2 text-center inline-flex items-center mr-2 dark:bg-yellow-400 dark:hover:bg-yellow-500 dark:focus:ring-blue-500">
        {{$t("edit")}}
